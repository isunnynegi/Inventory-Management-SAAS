  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">All organizations and users across StockKart.</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="text-left py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Store</th>
                  <th className="text-left py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Type</th>
                  <th className="text-left py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Email</th>
                  <th className="text-left py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Status</th>
                  <th className="text-left py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Joined</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {recentOrgs.map(org => (
                  <tr key={org._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 text-gray-500 capitalize">{STORE_TYPE_LABELS[org.storeType] ?? org.storeType}</td>
